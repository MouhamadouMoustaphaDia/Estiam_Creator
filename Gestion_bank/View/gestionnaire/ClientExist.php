...
<head>
	<meta charset="UTF-8">
         <title>Ajout d'un Client Existant</title>
...
if(isset($_GET['ok']))
{
    if($_GET['ok'] == 1)
    {
        ...
        echo '<div class="alert alert-danger">
                                   Client Introuvable, Contactez l\'administrateur
                          </div>';
    }
}
?>
        ...
        <div class="panel-body">
            <form method="POST" action="Controller/GestionnaireController.php">
               <div class="form-group">
                    <label class="control-label">Entrer le Code du Client</label>
                    <input class="form-control" type="text" name="Code" id="Code" required="required"/>
                </div>
               
               
                <div class="form-group">
                    <input class="btn btn-success" type="submit" name="RechercherCli" value="Envoyer"/>
